	...
	const predefinedAreas = await PredefinedArea.insertMany([
		{
			...
			district: ['Anjou'],
			districtCode: 'anj',
			coords: _toCoordsObj(45.6122993, -73.5899528),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			state: 'Quebec',
			city: 'Montreal',
			district: ['Ahunstic-Cartierville'],
			districtCode: 'ahc',
			coords: _toCoordsObj(45.5547972, -73.6777571),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			state: 'Quebec',
			city: 'Montreal',
			district: ['Montreal-Nord'],
			districtCode: 'mtl-n',
			coords: _toCoordsObj(45.602927, -73.6496184),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			districtCode: 'mtl-e',
			coords: _toCoordsObj(45.6292342, -73.546502),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Lasalle'],
			districtCode: 'las',
			coords: _toCoordsObj(45.4361082, -73.6591395),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Lachine'],
			districtCode: 'lac',
			coords: _toCoordsObj(45.4505633, -73.7181664),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			state: 'Quebec',
			city: 'Montreal',
			district: ['Saint-Leonard'],
			districtCode: 'leo',
			coords: _toCoordsObj(45.5888043, -73.6173978),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			state: 'Quebec',
			city: 'Montreal',
			district: ['Saint-Michel', 'Parc-Extension', 'Villeray'],
			districtCode: 'stmch',
			coords: _toCoordsObj(45.5446838, -73.6350267),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Rosement'],
			districtCode: 'rsmt',
			coords: _toCoordsObj(45.553827, -73.6058538),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			districtCode: 'pmtr',
			coords: _toCoordsObj(45.5233159, -73.6063665),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Outremont'],
			districtCode: 'outm',
			coords: _toCoordsObj(45.5160655, -73.6187685),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Westmount'],
			districtCode: 'wsmt',
			coords: _toCoordsObj(45.4848052, -73.6097335),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Mt-Royal'],
			districtCode: 'mtr',
			coords: _toCoordsObj(45.5071397, -73.6738939),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			districtCode: 'sl',
			coords: _toCoordsObj(45.4966238, -73.753911),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			state: 'Quebec',
			city: 'Montreal',
			district: ['Cote-des-Neiges', 'Hampstead', 'Notre-Dame-de-Grace'],
			districtCode: 'ndg',
			coords: _toCoordsObj(45.4673574, -73.6479913),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Fabreville'],
			districtCode: 'fbv',
			coords: _toCoordsObj(45.5746574, -73.9735),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Duvernay'],
			districtCode: 'duv',
			coords: _toCoordsObj(45.5953843, -73.6799281),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Vimont'],
			districtCode: 'vim',
			coords: _toCoordsObj(45.6063861, -73.7456115),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Chomedey'],
			districtCode: 'chd',
			coords: _toCoordsObj(45.5383503, -73.7375266),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Auteuil'],
			districtCode: 'aut',
			coords: _toCoordsObj(45.6304957, -73.7627909),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			district: ['Pont-Viau'],
			districtCode: 'pv',
			coords: _toCoordsObj(45.5709566, -73.6957849),
		},
		{
			id: new Types.ObjectId(),
			country: 'Canada',
			...
			districtCode: 'ldr',
			coords: _toCoordsObj(45.5560382, -73.7275401),
		},
	])
	...
	const courts = await createCourt([
		{
			districtCode: 'leo',
			type: 'outdoor',
			coords: _toCoordsObj(45.572681, -73.594074),
			fieldName: 'Dôme Hébert',
			schedule: {},
			available: true,
			isMultisportZone: false,
		},
		{
			districtCode: 'leo',
			type: 'outdoor',
			coords: _toCoordsObj(45.572686, -73.594151),
			fieldName: 'Stade Hébert',
			schedule: {},
			available: true,
			isMultisportZone: false,
		},
		{
			districtCode: 'leo',
			type: 'outdoor',
			coords: _toCoordsObj(45.5844653, -73.6085511),
			fieldName: 'Terrain de soccer du parc Coubertin',
			schedule: {},
			available: true,
			isMultisportZone: false,
		},
		{
			districtCode: 'leo',
			type: 'outdoor',
			coords: _toCoordsObj(45.5884481, -73.5707134),
			fieldName: 'Terrain de soccer du parc Giuseppe-Garibaldi',
			schedule: {},
			available: true,
			isMultisportZone: false,
		},
		{
			districtCode: 'leo',
			type: 'outdoor',
			coords: _toCoordsObj(45.578245, -73.604973),
			fieldName: 'Terrain de soccer du parc Luigi-Pirandello',
			schedule: {},
			available: true,
			isMultisportZone: false,
		},
		{
			districtCode: 'leo',
			type: 'outdoor',
			coords: _toCoordsObj(45.5872102, -73.608256),
			fieldName: 'Terrain de soccer du parc Pie-XII',
			schedule: {},
			available: true,
			isMultisportZone: false,
		},
		{
			districtCode: 'leo',
			type: 'outdoor',
			coords: _toCoordsObj(45.5971803, -73.5985679),
			fieldName: 'Terrains de soccer du parc Ferland',
			schedule: {},
			available: true,
			isMultisportZone: false,
		},
		{
			districtCode: 'leo',
			type: 'outdoor',
			coords: _toCoordsObj(45.572575, -73.591777),
			fieldName: 'Terrains de soccer du parc Hébert',
			schedule: {},
			available: true,
			isMultisportZone: false,
		},
	...
	const users = await createUser([
		{
			fullName: 'Tony Hakim',
			username: 'tony',
			preferredRegion: predefinedAreas[0],
